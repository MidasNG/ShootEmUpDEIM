...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Instantiate(Asteroid, new Vector2(Random.Range(-7f, 7f), 5f), Quaternion.Euler(0, 0, Random.Range(-125f, -45f)), transform);
        }
        ...
        {
            Instantiate(Asteroid, new Vector2(-7f, Random.Range(-5f, 5f)), Quaternion.Euler(0, 0, Random.Range(-45f, 45f)), transform);
        }

        if (Side == "R" && timeSinceLastSpawn == 1.5)
        {
            Instantiate(Asteroid, new Vector2(7f, Random.Range(-5f, 5f)), Quaternion.Euler(0, 0, Random.Range(-125f, -215f)), transform);
        }
